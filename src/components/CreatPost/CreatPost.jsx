    ...
    <>
      <div>
        <button
          ...
          className="block text-white cursor-pointer bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-2xl text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          type="button"
        >
          Creat Post
        </button>
              ...
              <div className="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                <div className="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600 border-gray-200">
                  ...
                  <button
                    onClick={() => changeShow()}
                    type="button"
                    className="end-2.5 text-gray-400 cursor-pointer bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                ...
                <div className="p-4 md:p-5">
                  <form
                    onSubmit={handleSubmit(handelAddPost)}
                    className="space-y-4"
                    action="#"
                  >
                    <div>
                    ...
                    <div className="mt-5">
                      <label
                        htmlFor="password"
                        className="block bg-violet-500 p-2.5 rounded-xl mb-2 text-sm font-medium text-gray-900 dark:text-white"
                      >
